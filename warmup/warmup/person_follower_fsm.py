...
class PersonFollowerNode(Node):
    ...
    def roate_to_target(self, min_dist_heading):
        dir = -1 
    ...
    def drive_to_target(self, min_dist):
        msg.linear.x = 0.2
    ...
    def run_loop(self):
        ...
        if (min_dist_heading >= 3 or min_dist_heading <= 357):
            roate_to_target(min_dist_heading)
        if else (min_dist > self.goal_dist):
            drive_to_target(min_dist)
        else:
            msg.linear.x = 0.0
            msg.angular.z = 0.0
